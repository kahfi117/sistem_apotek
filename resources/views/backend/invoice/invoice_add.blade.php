                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Obat Keluar </h4><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">Nama Obat </label>
                            ...
                            <form method="post" action="{{ route('invoice.store') }}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <textarea name="description" class="form-control" id="description" placeholder="Keterangan (Opsional)"></textarea>
                                    </div>
                                </div><br>
                                <input type="hidden" value="{{ $costomer->id }}" name="customer_id">

                                <br>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info" id="storeButton"> Buat Invoice</button>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, v) {
                            html += '<option value=" ' + v.id + ' "> ' + v.name + ' - ' + v.unit.name
                                '</option>';
                        });
