            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Supplier dan Ketegori Report </h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <strong> Obat Sort Kategori Report </strong>
                            ...
                            <div class="show_product" style="display:none; ">
                                <form method="GET" action="{{ route('product.wise.pdf') }}" id="myForm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="md-3">
                                                <label for="example-text-input" class="form-label">Kategori Obat </label>
