                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="invoice-title">
                                        <h4 class="float-end font-size-16"><strong>No Pembelian
                                                #{{ $invoice->invoice_no }}</strong></h4>
                                        @include('backend.pdf.title')
                                        <div class="col-6 mt-4 text-end">
                                            <address>
                                                <strong>Tanggal Pemebelian:</strong><br>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        <div class="p-2">
                                            <h3 class="font-size-16"><strong>Invoice</strong></h3>
                                        </div>
                                        <div class="">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <th width="10%"><strong>Pembelian </strong></th>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><strong>Jumlah Pembelian</strong>
                                                            </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($invoice['invoice_details'] as $key => $details)
                                                            <tr>
                                                                ...
                                                                <td class="text-end">Rp.{{ $details->selling_price }}</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="no-line text-end">Rp.{{ number_format($payment->discount_amount,2,',','.') ?? 0 }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="no-line"></td>
                                                            ...
                                                            <td class="no-line text-end">
                                                                <h4 class="m-0">Rp.{{ number_format($payment->total_amount,2,',','.') ?? 0 }}</h4>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
