                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">Tanggal Pembelian</label>
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">Obat </label>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('purchase.store') }}">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info" id="storeButton"> Buat Faktur</button>
