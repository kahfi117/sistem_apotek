                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Edit Data Obat </h4><br><br>
                            ...
                            <form method="post" action="{{ route('product.update') }}" id="myForm">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="unit_id" class="form-select" aria-label="Default select example">
                                            ...
                                            @foreach ($unit as $units)
                                                <option
                                                value="{{ $units->id }}"
                                                {{ $units->id == $product->unit_id ? 'selected' : '' }}
                                                >{{ $units->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Data Obat">
                            </form>
